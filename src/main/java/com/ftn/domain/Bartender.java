...
public class Bartender extends User{
    ...
    public Bartender(String first_name, String last_name, String email, String password, Role role, Date birth, int dressSize, int shoeSize, boolean firstTimeLogin) {
